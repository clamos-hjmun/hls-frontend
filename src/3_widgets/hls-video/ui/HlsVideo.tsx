    ...
    <div className={styles.wrapper} data-fsd="widget/ui/hls-video">
      ...
      <div className={styles.bottom}>
        ...
        <div className={styles.button_group}>
          ...
          {/* 캡처 버튼 */}
          <VideoCaptureButton video={videoRef.current} zoom={zoom} position={position} minimapRef={minimapRef} />
        </div>
      </div>
    </div>
  );
...
const Description = () => {
  const usageList = [
    ...
    { icon: <DescriptionIcons.Controller className={styles.icon} />, text: "컨트롤러를 이용한 화면 이동 및 확대/축소" },
    {
